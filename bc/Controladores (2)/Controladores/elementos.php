...
class elementos extends baseCrud{
	...
	//Modifiqué la función para el guardado, agregandole el campo de observaciones en el arreglo de la info
		...
		if($resultado['ejecuto']){
			$info = [
				'info' => [
					...
					'observaciones' => isset($datos['info']['observaciones']) ? $datos['info']['observaciones'] : null
				]
			];
