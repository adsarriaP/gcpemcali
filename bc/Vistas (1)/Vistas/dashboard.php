            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4">                     
                    <div class="form-group row">                         
                        <label for="vigencia" class="col-sm-3 col-form-label">Mes</label>                         
                        <div class="col-sm-5">                             
                        ...
                        <div class="col-sm-2">                             
                            <button type="button" class="btn btn-primary btn-sm" id="exportar" title="Exportar">                                 
                                <i class="fas fa-file-download"></i>                             
                            </button>                                                      
                        </div>                          
                        <div class="col-sm-2">                             
                            <button onclick="exportarProductividad()" class="btn btn-success btn-sm">                                 
